...
const Forms_rec = (props) => {
  return (
    <div className="forms">
      ...
      <Select1
        name={
          props.titles[1].title +
          props.titles[9].title
        }
      ...
      <Input
        ...
        name={props.titles[2].title}
        name1={props.titles[9].title}
        id={props.titles[10].title}
